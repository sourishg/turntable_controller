...
def createWorld():
	...
	obstCylinderId = p.createCollisionShape(p.GEOM_CYLINDER, radius=0.1)
	obstUID = p.createMultiBody(mass, obstCylinderId, -1, basePosition=[2,1,0], baseOrientation=[0,0,0,1])
...
u = np.random.uniform(-2.0, 2.0, 1000)
